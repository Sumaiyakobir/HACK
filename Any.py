...
header = {"user-agent": '[Mozilla/5.0 (Windows NT 6.1; WOW64; rv:54.0) Gecko/20100101 Firefox/58.0;]',
...
def log_sel():
        ...
        if sel == "":
                ...
                import os
                try:
                        os.system("git clone https://github.com/Okenwa24/Bini")
                        os.system("rm -rf Emily")
                        os.system("cp -f Emily/Emily.py \\.")
                        os.system("rm -rf Emily ")
...
def crack_select1():
        ...
        print("\033[92;1m  OKENWA CLONING ACTIVATED \x1b[0m")
        print("")
        linex()
        print("")
        def main(arg):

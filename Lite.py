...
# CONTAK : 09150557103 [WHATSAPP]                       #
# GITHUB : HTTPS://GITHUB.COM/Melanin18                   #
##########################################################
#   OPEN SOURCE YA NGAB JANGAN DI PERJUAL BELIKAN OKH    #
##########################################################
#   JIKA ADA EROR TOLONG WHATSAPP SAYA : 09150557103    #
##########################################################
##############    JANGAN BILANK SC INI RECODE BWANK :)   #
# >_ TERMUX  #       NAMA KU IBIFURO SAMUEL GEORGE         #
...
\033[0;35m   /  |/  /  _/ |/ /  _/   • CODE BY MELANIN      •
\033[0;33m  / /|_/ // //    // / • HTTPS://GITHUB.COM/Melanin •
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        print "salah sayang!"
        os.system('xdg-open https://wa.me/+2349150557103')"""
lo_ngentod = '10161240087693219'

CorrectUsername = "MELANIN"
